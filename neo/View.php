...
use Neo\Helpers\FileSystem\File;
use Neo\Helpers\FileSystem\Path;
use Neo\Helpers\Primitives\Arr;
use Neo\Helpers\Primitives\Str;
use Neo\Helpers\Regex;
use Exception;
...
class View
{
    ...
    {
        static::$templatePath = Path::abs(sprintf('public/resources/views/%s.blade.php', $template));
